...
public abstract class WorkRequest {
    ...
    private User_Account sender;
    private User_Account receiver;
    ...
    public User_Account getSender() {
        return sender;
    }

    public void setSender(User_Account sender) {
        this.sender = sender;
    }

    public User_Account getReceiver() {
        return receiver;
    }
    ...
    public void setReceiver(User_Account receiver) {
